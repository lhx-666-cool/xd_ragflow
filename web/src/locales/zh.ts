...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图的模块化检索增强生成 (RAG) 系统`,
    ...
    dashboard: {
      title: '活跃度统计',
      subtitle: '系统的活跃用户与模型使用情况。',
      totalUsers: '注册用户总数',
      activeUsersInWindow: '近 {{days}} 天活跃用户',
    ...
    setting: {
      ...
      noPublicApiSupport: '暂不提供对公网api的支持',
      team: '团队',
      system: '系统',
      logout: '登出',
      api: 'API',
    ...
    fileManager: {
      ...
      buildTextbookKg: '构建教材知识图谱',
      buildTextbookKgDescription:
        '上传后将 PDF 教材提交到独立的 MinerU 与教材 KG 服务。',
      textbookKgOnlyPdf: '教材 KG 当前只支持 PDF 文件。',
      textbookKgSubmitFailed: '文件已上传，但教材 KG 任务提交失败。',
      textbookKgPartialFailure: '部分文件已上传，但教材 KG 任务未能启动。',
      textbookKgSubmitted: '教材 KG 任务已提交。',
      textbookKg: '教材 KG',
      textbookKgDownload: '下载 KG 产物',
      textbookKgRetry: '重试',
      textbookKgCancel: '取消',
      textbookKgCounts: '实体 / 关系 / chunks',
      textbookKgDownloadFailed: '教材 KG 产物下载失败。',
      textbookKgViewGraph: '在 RAGFlow 中查看知识图谱',
      textbookChapterTree: '查看教材章节树',
      textbookChapterTreeLoading: '正在读取章节树…',
      textbookChapterTreeLoadFailed: '章节树读取失败，请稍后重试。',
      textbookChapterTreeSummary: '共 {{nodes}} 个节点 · {{depth}} 层',
      textbookChapterTreeExpandAll: '展开全部章节',
      textbookChapterTreeCollapseAll: '折叠全部章节',
      textbookChapterTreeLevel: '第 {{level}} 层',
      textbookChapterTreePdfPages: 'PDF 页码',
      textbookChapterTreeTocPages: '教材页码',
      textbookChapterTreeChildren: '下级节点',
      textbookChapterTreeContentPreview: '章节内容摘要',
      textbookChapterTreeNoContent: '该节点仅用于组织章节层级，没有独立正文。',
      textbookChapterTreeEmpty: '该教材没有可展示的章节节点。',
      textbookKgImportRetry: '重试导入 GraphRAG',
      textbookKgGraphRagStatus: {
        pending: '等待导入 GraphRAG',
        importing: '正在导入 GraphRAG',
        imported: '已进入 GraphRAG',
        failed: 'GraphRAG 导入失败',
      },
      textbookKgStatus: {
        queued: '排队中',
        running: '构建中',
