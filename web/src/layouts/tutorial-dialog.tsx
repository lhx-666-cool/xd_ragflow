...
![](/tutorial/images/图片1.png)

<center>图1 慧通登录界面</center>

![](/tutorial/images/图片2.png)

<center>图2 西安电子科技大学统一身份认证</center>

![](/tutorial/images/图片3.png)
...
![](/tutorial/images/图片8.png)

<center>图8 新建知识库</center>

![](/tutorial/images/图片9.png)
...
![](/tutorial/images/图片15.png)

<center>图15 默认聊天智能体</center>

### 2．新建聊天

![](/tutorial/images/图片16.png)
...
![](/tutorial/images/图片17.png)

<center>图17 个人聊天模块配置</center>

![](/tutorial/images/图片18.png)
...
export function TutorialDialog({ open, onOpenChange }: TutorialDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!w-[min(896px,90vw)] !max-w-none h-[85vh] flex flex-col p-0 overflow-hidden">
        <DialogHeader className="px-6 pt-6 pb-4 border-b">
          <DialogTitle className="text-xl">慧通使用教程</DialogTitle>
        </DialogHeader>
            ...
            components={{
              img: ({ src, alt, ...props }) => (
                <img
                  src={src}
                  alt={alt}
                  style={{ width: '100%', height: 'auto', display: 'block', margin: '8px auto' }}
                  {...props}
                />
              ),
              h1: ({ children }) => (
